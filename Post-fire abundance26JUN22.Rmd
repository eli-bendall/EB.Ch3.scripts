---
title: "post-fire abundance_juveniles"
...
DSF.abund2 <- ggplot(data = dat.gg1, aes (x = var)) +
...
## replace an NA with zero
```{r}
dat.model.r.WSF[is.na(dat.model.r.DSF)] <- 0
...
WSF.abund2 <- ggplot(data = dat.gg1.b, aes (x = var)) +
